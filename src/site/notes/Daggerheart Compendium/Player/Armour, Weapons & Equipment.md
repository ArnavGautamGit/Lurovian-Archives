---
{"dg-publish":true,"permalink":"/daggerheart-compendium/player/armour-weapons-and-equipment/"}
---
...
When you’re using a weapon that you could theoretically throw (such as a dagger or an axe), you can throw it at a target within [[Daggerheart Compendium/General/Maps, Range & Movement\|Very Close range]], making an attack roll using [[Finesse\|Finesse]]. 
...
---
## Armour Statistics
Each Armour has a Name, Base Damage Thresholds and Base [[Daggerheart Compendium/Player/Armour Score\|Armour Score]] which defines the number of [[Daggerheart Compendium/Player/Armour Slots\|Armour Slots]] the Armour provides before it needs to be repaired. Additionally a piece of Armour may also grant a feature.

There are other forms of equipment such as shields which are counted as weapons but functionally act as armour - providing features that add [[Daggerheart Compendium/Player/Armour Slots\|Armour Slots]] and such.
...
Each armor has its own [[Daggerheart Compendium/Player/Armour Slots\|Armour Slots]], as recorded in the boxes in that section; if your character switches armour, be sure to keep track of how many [[Daggerheart Compendium/Player/Armour Slots\|Armour Slots]] you’ve marked on the old armour, especially if you are giving it to a party member. You can't carry additional armour in your inventory.

### Reducing Damage
One can reduce damage by using a maximum of 1x [[Daggerheart Compendium/Player/Armour Slots\|Armour Slots]] per attack unless they have a feature to use more slots. 
...
### Unarmoured
Going unarmored does not give your character any bonuses or penalties, but while unarmoured, they have an [[Daggerheart Compendium/Player/Armour Score\|Armour Score]] of 0, their Major threshold is equal to their level, and their Severe threshold is equal to twice their level.

### Reflavouring Armour
As with weapons, class abilities, and domains, you can reflavor your character’s armour to suit them. A wizard using full plate armour might describe their protection as coming from heavily enchanted robes and protective rings, while their penalty to [[Daggerheart Compendium/Player/Evasion Score\|Evasion Score]] and [[Agility\|Agility]] is due to the intense focus required to maintain such powerful protective magic.

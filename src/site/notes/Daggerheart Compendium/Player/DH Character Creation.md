---
{"dg-publish":true,"permalink":"/daggerheart-compendium/player/dh-character-creation/","tags":["TTRPG"]}
---


---
# Creating a Daggerheart Character
> This note describes the Character Creation process for a game of [[Daggerheart Compendium/Daggerheart\|Daggerheart]] using a Digital or Paper-based Character Sheet.

Things your character needs before completion:
[[Daggerheart Compendium/Player/DH Character Creation#Character Class\|Character Class]]
[[Daggerheart Compendium/Player/DH Character Creation#Character Heritage\|Character Heritage]]
[[Daggerheart Compendium/Player/DH Character Creation#Character Traits\|Character Traits]]
[[Daggerheart Compendium/Player/DH Character Creation#Starting Equipment\|Starting Equipment]]
[[Daggerheart Compendium/Player/DH Character Creation#Additional Character Information\|Additional Information]]
[[Daggerheart Compendium/Player/DH Character Creation#Character Background\|Character Background (Backstory)]]
[[Daggerheart Compendium/Player/DH Character Creation#Character Experiences\|Character Experiences]]
[[Daggerheart Compendium/Player/DH Character Creation#Connections (Optional)\|Connections (Optional)]]
[[Daggerheart Compendium/Player/DH Character Creation#Domain Cards\|Domain Cards]]
...
Multi-classing in 2 or more classes (max 3) is allowed as per [[Daggerheart Compendium/Player/DH Multiclassing Rules\|DH Multiclassing Rules]].

Here is a list of classes which provide an overview of what each Class and Subclass allows you to play as:

[[Daggerheart Compendium/Player/Classes/Bard (DH)\|Bard (DH)]] 
...
[[Daggerheart Compendium/Player/Classes/Druid (DH)\|Druid (DH)]]
...
[[Daggerheart Compendium/Player/Classes/Guardian (DH)\|Guardian (DH)]]
...
[[Daggerheart Compendium/Player/Classes/Ranger (DH)\|Ranger (DH)]]
...
[[Daggerheart Compendium/Player/Classes/Seraph (DH)\|Seraph (DH)]]
...
[[Daggerheart Compendium/Player/Classes/Rogue (DH)\|Rogue (DH)]]
...
[[Daggerheart Compendium/Player/Classes/Sorcerer (DH)\|Sorcerer (DH)]]
...
[[Daggerheart Compendium/Player/Classes/Warrior (DH)\|Warrior (DH)]]
...
[[Daggerheart Compendium/Player/Classes/Wizard (DH)\|Wizard (DH)]]
...
### Character Heritage
Heritage of Characters is based on combining the [[Daggerheart Compendium/Player/Ancestries/DH Species Ancestry\|DH Species Ancestry]] and the strata of society (reflected by [[Daggerheart Compendium/Player/DH Community Heritage\|DH Community Heritage]]) the character was born in.

Choose one of both and then write them in your sheet as "Community Species".
Example: "[[Daggerheart Compendium/Player/DH Community Heritage#Highborne\|Highborne]] [[Daggerheart Compendium/Player/Ancestries/Human (DH)\|Human]]"
...
Armour Type will affect the total number of [[Daggerheart Compendium/Player/Armour Slots\|Armour Slots]] and also depending upon how bulky the chosen armourset is, it may also change the [[Daggerheart Compendium/Player/Evasion Score\|Evasion Score]]. Only one Armour Slot can be used against an attack. The use of Armour immediately reduces damage to a lower damage threshold.

Weapons may (and generally do) have special features that alter the [[Daggerheart Compendium/Player/DH Character Creation#Character Traits\|Traits]] so be sure to update the values! It is advised to write your [[Daggerheart Compendium/Player/Armour Score\|Armour Score]] and [[Daggerheart Compendium/Player/Evasion Score\|Evasion Score]] last since Armour Scores can changed based on [[Daggerheart Compendium/Player/DH Character Creation#Character Class\|Character Class and Subclass]].

### Additional Character Information
Now is the time to finalise your [[Daggerheart Compendium/Player/Evasion Score\|Evasion Score]]! Starting Evasion Score is different from Class to Class and you can easily add or subtract any modifiers from armour or weapons into your evasion score.
...
If you wamt to switch out Domain Cards, each Card has a [[Daggerheart Compendium/Player/Stress Point\|Stress Point]] indicator, you can mark off the number of Stess Points the new card (which was outside your Loadout) and swap that with another card of the same Domain. This is where 0 stress cards come in handy. They may not be as strong, but when you need them specifically, those cards can be swapped in at 0 Stress Points.

The Kind of Domain Cards you have is dependent on your [[Domains in Daggerheart (DH)\|Domain]] - which is influenced by your [[Daggerheart Compendium/Player/DH Character Creation#Character Class\|#Character Class]]. You are only able to take 1 domain from a class if you multi-class. See [[Daggerheart Compendium/Player/DH Multiclassing Rules\|DH Multiclassing Rules]] for more info. This means that you can only get domain cards for that domain.
...
- The Character is allowed to take another [[Daggerheart Compendium/Player/DH Character Creation#Character Experiences\|Character Experience]].
- The character is given one [[Daggerheart Compendium/Player/Proficiency\|Proficiency]] i.e., if the character was rolling nd6 for their weapon, they will now role (n+1) number of d6 dice.

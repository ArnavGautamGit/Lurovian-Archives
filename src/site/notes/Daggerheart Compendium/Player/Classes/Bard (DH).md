---
{"dg-publish":true,"permalink":"/daggerheart-compendium/player/classes/bard-dh/","tags":["TTRPG"]}
---


---
# Bard (DH)
> A [[Daggerheart Compendium/Player/DH Character Creation#Character Class\|Character Class]] of a charismatic Musician, Wordmith or Motivator in every famous Table-Top Role-Playing Game which includes [[Daggerheart Compendium/Daggerheart\|Daggerheart]]. Bards can cast spells for either motivationg or healing their allies with a few utility spells.
> {See: [[Daggerheart Compendium/Player/DH Character Creation#Character Class\|Character Creation's Section on "Character Class"]] to get a general overview of classes}
...
Base [[Daggerheart Compendium/General/Hit Point Slots\|Hit Point Slots]]: 5
...
***Make a Scene***: Bard can spend 3x [[Hope Token\|Hope Token]] to temporarily distract any target, giving them a -2 penalty on their [[Daggerheart Compendium/General/Difficulty Score\|Difficulty Score]].
...
The players can choose to roll this "Rally Dice" whose result can be added to an action roll, reaction roll, damage roll or clear the number of [[Daggerheart Compendium/Player/Stress Point\|Stress Points]] equal to the value rolled on the dice. 
...
- ***==Wordsmith==*** allows players to roleplay a poetic bard who uses captivating words and inspiring wordplay to aid any comrades.
	- ***Foundation Features***
		...
		- ***Rousing Speech***: Once per long rest, you can use an action to give a heartfelt, inspiring speech. All allies in Far Range clear 2x [[Daggerheart Compendium/Player/Stress Point\|Stress Point]].
...
- ***==Troubadour==*** allows players to rolepay the musical bard who inspires any comrades using the power of songs and music. You have to choose an instrument that you play throughout this campaign.
	- ***Foundation Feature - "Gifted Performer"***
		- Allows the Bard to play each of the following songs once:
			- With a ***relaxing song***, you and any allies in Close Range clear 1 [[Daggerheart Compendium/General/Hit Point Slots\|HP Slot]].
	...
	- ***Specialisation Feature - "Maestro"***
		...
		- Anyone who receives a Rally Dice can clear a [[Daggerheart Compendium/Player/Stress Point\|Stress Point]] or gain a [[Hope Token\|Hope Token]].

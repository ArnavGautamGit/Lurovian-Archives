---
{"dg-publish":true,"permalink":"/daggerheart-compendium/player/classes/druid-dh/","tags":["TTRPG"]}
---


---
# Druid (DH)
> A [[Daggerheart Compendium/Player/DH Character Creation#Character Class\|Character Class]] of a forst-dwelling and nature-loving, shape-shifters who can take the form of a beast & gain any temporary [[Daggerheart Compendium/General/Hit Point Slots\|Hit Point Slots]] if specific rules such as [[Daggerheart Compendium/Player/Classes/Druid (DH)#Druid's Hope - Special Ability\|Druid's Hope]] are leveraged.

Druids in [[Daggerheart Compendium/Daggerheart\|Daggerheart]], live in small closed settlements and are oblivious to the details of how society at large works. For reference, take [[Critical Role\|Critical Role]] Campaign 3's druid character played by Ashley.
...
### Base Scores
Base [[Daggerheart Compendium/Player/Evasion Score\|Evasion Score]]: 10
Base [[Daggerheart Compendium/General/Hit Point Slots\|Hit Point Slots]]: 6
...
***Evolution***: Druids can use these 3x [[Hope Token\|Hope Token]] to enter Beastform *without* marking 1x [[Daggerheart Compendium/Player/Stress Point\|Stress Point]]
...
- ***Beastform***: Mark 1x [[Daggerheart Compendium/Player/Stress Point\|Stress Point]] to into magical creature of your choice from the Beastform list (Homebrew allowed on [[Game Master (GM)\|GM]]'s prior approval). 
	...
	- This form still allows the Druid to freely mark [[Daggerheart Compendium/Player/Armour Slots\|Armour Slots]] & the form is immediately dropped on the last [[Daggerheart Compendium/General/Hit Point Slots\|HP Slot]] marked or when the player takes Major Damage in any beastform which has the "fragile" feature.
...
- ***==Warden of the Elements==*** gives the option to the players to embody the natural elements of nature and play Support. Spellcasting trait for this subclass is [[Instinct\|Instinct]].
	- ***Foundation Feature***
		- **Elemental Incarnation**: Mark a stress to channel or embody an elemental spirit from the given list. The embodiment ends if the Druid takes Severe Damage or short rest. Incarnations can overlap with Beastform.
			...
			- *Earth*: Gain a bonus to your damage thresholds equal to [[Daggerheart Compendium/Player/Proficiency\|Proficiency]].
			- *Water*: When you deal damage to an enemy in Melee Range of you, other enemies in Very Close Range must mark 1x [[Daggerheart Compendium/Player/Stress Point\|Stress Point]].
			- *Air*: Gain ability to hover & gain [[Daggerheart Compendium/Player/Duality Dice#Advantage & Disadvantage\|advantage]] on Agility Rolls.
	- ***Specialisation Feature***
		- **Elemental Aura**: Once per rest, you can assume an elemental aura of your matching *Elemental Incarnation*.
			- *Fire*: When enemy marks 1x or more [[Daggerheart Compendium/General/Hit Point Slots\|Hit Point Slots]] of damage, they must also mark 1x [[Daggerheart Compendium/Player/Stress Point\|Stress Point]].
	...
	- ***Mastery Feature***
		- While in *Elemental Incarnation*, further embody the elemental spirit to get one of the following benefits depending on element chosen:
			- *Fire*: Your [[Daggerheart Compendium/Player/Proficiency\|Proficiency]] increases by +1 for attacks and spells that deal damage.
			- *Earth*: When you take damage & mark [[Daggerheart Compendium/General/Hit Point Slots\|Hit Point Slots]], roll d6 for each slot marked. On each result of 6, mark 1 slot less. 
			- *Water*: When you are hit by an attack, you can mark 1x [[Daggerheart Compendium/Player/Stress Point\|Stress Point]] to make the attacker [[Vulnerable\|Vulnerable]].
			- *Air*: You gain +1 to your [[Daggerheart Compendium/Player/Evasion Score\|Evasion Score]] and can fly.
- ***==Warden of Renewal==*** gives the ability to the Druid to heal allies and play as a forest-based Healer of the group. Spellcast Trait for this subclass is [[Instinct\|Instinct]].
	- ***Foundational Features***
		...
		- **Regeneration**: Touch a creature & spend 3x [[Hope Token\|Hope Token]] to clear 1d4 [[Daggerheart Compendium/General/Hit Point Slots\|Hit Point Slots]].
	- ***Specialisation Features***
		- **Regeneration Upgrade**: It can be used on a creature within Very Close Range.
		- **Warden's Protection**: Once per long rest, spend 2x [[Hope Token\|Hope Token]] to clear 2 [[Daggerheart Compendium/General/Hit Point Slots\|HP Slots]] of 1d4 allies.
	- ***Mastery Feature***
		- ***Defender***: The Druid's Beastform embodies a healing spirit, when an ally in Close Range marks more than 2x [[Daggerheart Compendium/General/Hit Point Slots\|HP Slots]], the Druid can mark 1x [[Daggerheart Compendium/Player/Stress Point\|Stress Point]] to reduce the amount of HP Slots their allies mark down to 1.
...
- Beastform has specific restrictions into which animals a druid can transform into, they're here
	...
	- ***Evasion***: While transformed, you add the creature’s Evasion bonus to your normal [[Daggerheart Compendium/Player/Evasion Score\|Evasion]]. For example, if your Evasion is usually 8 and your Beastform says “Evasion +2,” your Evasion becomes 10 while you’re in that form.

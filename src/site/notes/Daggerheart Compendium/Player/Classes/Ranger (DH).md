---
{"dg-publish":true,"permalink":"/daggerheart-compendium/player/classes/ranger-dh/","tags":["TTRPG"]}
---


---
# Ranger (DH)
> A [[Daggerheart Compendium/Player/DH Character Creation#Character Class\|Character Class]] of a protector of the wilderness and their home forest. A brilliant Navigator seen most commonly wielding a bow - The Ranger in [[Daggerheart Compendium/Daggerheart\|Daggerheart]], similar to their [[Ranger (D&D)\|D&D equivalent]] is a useful ally to have as they are accustomed to fight without the support of an organised military, form great tacticians and use Guerilla Warfare at their finest.
...
- All damage rolls also deals a [[Daggerheart Compendium/Player/Stress Point\|Stress Point]].
- If any attack misses, you can drop the Focus to reroll your [[Daggerheart Compendium/Player/Duality Dice\|Duality Dice]] & take the new result.
...
- ***==Wayfinder==*** allows the players to play the expert navigator who can navigate the lands using trails & tracks to either hunt down enemies or rescue friends. Spellcasting Trait is [[Agility\|Agility]].
	- ***Foundation Feature***
		- ***Ruthless Predator:*** Mark 1x [[Daggerheart Compendium/Player/Stress Point\|Stress Point]] before yor damage roll to increase your [[Daggerheart Compendium/Player/Proficiency\|Proficiency]] by 1. Also, enemies mark 1x Stress when you deal Severe Damage.
	...
	- ***Specialisation Feature***
		- ***Elusive Predator:*** When you are attacked by your Focus Target, your [[Daggerheart Compendium/Player/Evasion Score\|Evasion Score]] increases by +2 for that attack.
	- ***Mastery Feature***
...
- ***==Beastbound==*** allows the player to keep an animal companion which attacks independently in Melee/Very Close range. Spellcasting Trait is [[Agility\|Agility]].
	...
	- ***Specialisation Feature***
		...
		- ***Battle-Bonded:*** When an enemy tries to attack you, you gain +2 to [[Daggerheart Compendium/Player/Evasion Score\|Evasion Score]] against that attack as long as the companion is in melee range of the attacking enemy.
	- ***Mastery Feature***
		- ***Advanced Training:*** Gain 2 additional level up options for your companion instantly.
		- ***Loyal Friend:*** Once per long rest when both you & your comapnion are in close range of each other, if you marks their last [[Daggerheart Compendium/General/Hit Point Slots\|HP Slot]] or the companion marks its last [[Daggerheart Compendium/Player/Stress Point\|Stress Point]] then the other rushes and takes that damage instead.

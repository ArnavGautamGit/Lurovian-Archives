---
{"dg-publish":true,"permalink":"/daggerheart-compendium/player/classes/wizard-dh/","tags":["TTRPG"]}
---


---
# Wizard (DH)
> A [[Daggerheart Compendium/Player/DH Character Creation#Character Class\|Character Class]] of strong spellcasters who using their Knowledge have acquired immensely powerful spells. Optimise the character by investing in [[Knowledge\|Knowledge]].
...
***Strange Patterns*** allows the Wizard to choose a number between 1 to 12. Whenever you roll that number on either Duality Dice, gain a [[Hope Token\|Hope Token]] or clear a [[Daggerheart Compendium/Player/Stress Point\|Stress Point]]. This number will change at Long Rest.
...
- ***==School of Knowledge==*** are the studious Wizards who have great knowledge of Magic and the world around them.
	- ***Foundation Feature***
		...
		- **Adept**: Mark a [[Daggerheart Compendium/Player/Stress Point\|Stress Point]] to use an Experience instead of a [[Hope Token\|Hope Token]], when you use this Feature, your Experience Modifier is doubled for tht roll.
...
- ***==School of War==*** is a subclass which uses magic for War almost exclusively.
	- ***Foundation Feature***
		- ***Battlemage:*** Gain an extra +1 [[Daggerheart Compendium/General/Hit Point Slots\|Hit Point Slots]] (Base is now 6)
		- ***Face Your Fear:*** Add 1d10 magic damage if an attack roll succeeds with Fear.
	- ***Specialisation Feature***
		- ***Conjure Shield:*** You can maintain a protective barrier of magic. As long as you have 2 or more [[Hope Token\|Hope Token]], you can add your [[Daggerheart Compendium/Player/Proficiency\|Proficiency]] to your [[Daggerheart Compendium/Player/Evasion Score\|Evasion Score]]. 

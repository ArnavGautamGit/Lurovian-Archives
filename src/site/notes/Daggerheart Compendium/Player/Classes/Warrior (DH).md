---
{"dg-publish":true,"permalink":"/daggerheart-compendium/player/classes/warrior-dh/","tags":["TTRPG"]}
---


---
# Warrior (DH)
> A [[Daggerheart Compendium/Player/DH Character Creation#Character Class\|Character Class]] of strong soldiers who may be a part of organised military or mercenary or a lone wolf. Known for great [[Strength\|Strength]] and Skill. More Agile than [[Daggerheart Compendium/Player/Classes/Guardian (DH)\|Guardians]] but unlike Guardians, cannot protect others from harm
...
### Base Scores
Base [[Daggerheart Compendium/Player/Evasion Score\|Evasion Score]]: 11
...
- ***==Call of the Brave==*** allows the player to play as a brave Warrior who does not shy from Battle (play [[Daggerheart Compendium/Player/Classes/Guardian (DH)\|Guardian (DH)]] at this point, in my opinion)
	- ***Foundation Feature***
		- ***Courage***: When you fail a roll with Fear, you gain 1x [[Hope Token\|Hope Token]].
		- ***Battle Ritual:*** Once per long rest, before you attempt something incredibly dangerous or face off against a foe who clearly outmatches you, describe what ritual you perform or preparation you make, then clear 2x [[Daggerheart Compendium/Player/Stress Point\|Stress Point]] and gain 2x [[Hope Token\|Hope Token]].
	- ***Specialisation Feature***
		- ***Rise to the Challenge:*** You are vigilant in the face of mounting danger. While you have $\leq$ 2 [[Daggerheart Compendium/General/Hit Point Slots\|Hit Point Slots]] unmarked, your Hope die becomes a d20.
	- ***Mastery Feature***

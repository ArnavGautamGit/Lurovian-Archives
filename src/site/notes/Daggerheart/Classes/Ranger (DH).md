...
- ***==Wayfinder==*** allows the players to play the expert navigator who can navigate the lands using trails & tracks to either hunt down enemies or rescue friends. Spellcasting Trait is [[Agility\|Agility]].
	- ***Foundation Feature***
		- ***Ruthless Predator:*** Mark 1x [[Stress Point\|Stress Point]] before yor damage roll to increase your [[Daggerheart/Mechanics/Proficiency\|Proficiency]] by 1. Also, enemies mark 1x Stress when you deal Severe Damage.
	...
	- ***Specialisation Feature***
		- ***Elusive Predator:*** When you are attacked by your Focus Target, your [[Daggerheart/Mechanics/Evasion Score\|Evasion Score]] increases by +2 for that attack.
	- ***Mastery Feature***
...
- ***==Beastbound==*** allows the player to keep an animal companion which attacks independently in Melee/Very Close range. Spellcasting Trait is [[Agility\|Agility]].
	...
	- ***Specialisation Feature***
		...
		- ***Battle-Bonded:*** When an enemy tries to attack you, you gain +2 to [[Daggerheart/Mechanics/Evasion Score\|Evasion Score]] against that attack as long as the companion is in melee range of the attacking enemy.
	- ***Mastery Feature***
		- ***Advanced Training:*** Gain 2 additional level up options for your companion instantly.
		- ***Loyal Friend:*** Once per long rest when both you & your comapnion are in close range of each other, if you marks their last [[Hit Point Slots\|HP Slot]] or the companion marks its last [[Stress Point\|Stress Point]] then the other rushes and takes that damage instead.
